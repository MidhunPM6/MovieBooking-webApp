...
<div className="mb-20">
      ...
      <div className="flex place-content-center mr-16 mt-20">
        ...
        <div className="bg-slate-200 w-[360px] rounded-r-lg pt-20">
          <ToastContainer/>
        <div className="flex place-content-center">
          ...
          <form action="" className="flex flex-col ">
            ...
            <div className="flex text-white">
              <button onClick={handlesignup }className="bg-yellow-400 text-white py-2 w-36  rounded-lg hover:bg-white hover:text-black hover:border-solid border-2 border-yellow-400 drop-shadow-md ml-12 mt-12" >
                Sign up
              </button>
